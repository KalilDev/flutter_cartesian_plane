...
PackedUint8List processImage(PixelDataMessage data) {
  //return _cProcessImage(data);

  final byteCount = 4 * data.width * data.height;
  final timer = Stopwatch()..start();
  final uint8List = createUint8List(byteCount);
  ...
  timer.stop();
  print('gud: ${timer.elapsedMicroseconds}');
  return uint8List;
}
